...
tags: [principles, decision-making, judgment, binding]
provenance:
  decided_by: ML1
  decided_on: 2026-01-24
  context: Codifies binding principles that govern judgment and decision-making when procedures do not fully determine an outcome
---
...
1. **System Principles** — define what the system is and how it must behave
2. **Substantive Decision Principles** — define how judgment is made under ambiguity
...
3. Escalate to ML1 for resolution
4. Record the resolution with principle citations
