...
| 2 | Define Solution options for Matter Overview | Schema | 2026-01-22 | Open | Placeholder only in template and schema |
...
| 6 | Create client registry (client number mapping) | Schema | 2026-01-22 | Open | Matter IDs use 3-digit client numbers with no central lookup |
