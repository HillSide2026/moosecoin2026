...
> **No general rule, template, or playbook may be inferred from a Matter without explicit extraction and approval.**
...
- Template-worthy document structures
...
04_MATTERS (observation)
   ...
   ML1 approval
       ↓
   Canon (01_DOCTRINE / 02_PLAYBOOKS / 03_TEMPLATES)
```
...
6. Artifact promoted to `03_TEMPLATES/checklists/`
