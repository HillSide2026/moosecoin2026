...
- May write new files within `04_PROJECTS/**` for program coordination artifacts.
- May edit and overwrite existing files within `04_PROJECTS/**`.
- All writes outside `04_PROJECTS/**` remain restricted to `09_INBOX/_AGENT_OUTPUT/` only.

### `portfolio-manager`

- May write new files within `04_PROJECTS/**` for portfolio coordination artifacts.
- May edit and overwrite existing files within `04_PROJECTS/**`.
- All writes outside `04_PROJECTS/**` remain restricted to `09_INBOX/_AGENT_OUTPUT/` only.
...
| Write to `02_MODELS/` | Models are canon, promotion-gated |
| Write to `03_PROTOCOLS/` | Protocols are canon, promotion-gated |
