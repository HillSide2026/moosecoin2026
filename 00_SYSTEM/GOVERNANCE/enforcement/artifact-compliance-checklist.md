...
| 02_MODELS | `model_type`, `model_components`, `cites_doctrine` |
| 03_PROTOCOLS | `protocol_type`, `version`, `approval_status` |
...
- [ ] File is in an LL-consumable folder (01_DOCTRINE, 03_PROTOCOLS, 06_OUTPUTS)
...
- [ ] No files at repository root (except `LICENSE`, `README.md`, `CLAUDE.md`)
