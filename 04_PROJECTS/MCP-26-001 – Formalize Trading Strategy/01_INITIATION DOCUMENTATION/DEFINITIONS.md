...
| Location | `01_DOCTRINE/` (canonical doctrine subdirectories) |
...
| Authority Level | Procedural (`authority.level: procedural`) |
| Location | `03_PROTOCOLS/checklists/` |
...
|-------|---------------|---------------------|-----------|
| Strategy | Doctrine | `01_DOCTRINE/` | Binding, Source-of-Truth |
| Approach | Model | `02_MODELS/` | Procedural, Not Source-of-Truth |
| Tactics | Checklist | `03_PROTOCOLS/checklists/` | Procedural, Not Source-of-Truth |
...
2. **Trading Approach Model** (Level 2)
