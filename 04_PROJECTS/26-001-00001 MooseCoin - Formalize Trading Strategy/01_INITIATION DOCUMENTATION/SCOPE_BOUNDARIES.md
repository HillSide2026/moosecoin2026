...
**Format:** Binding doctrine (`01_DOCTRINE/binding/`)

### 2. Trading Approach Playbook
...
**Format:** Procedural playbook (`02_PLAYBOOKS/`)
...
**Format:** Template checklists (`03_TEMPLATES/checklists/`)
